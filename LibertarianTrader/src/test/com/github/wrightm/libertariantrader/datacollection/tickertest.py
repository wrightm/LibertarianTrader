...
class TickerTest(unittest.TestCase):
    ...
    def testEqualTickers(self):
        ...
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentNames(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("NotGoogle", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentDates(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-2013", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentOpen(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "1000000.00", "110.00", "90.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentHigh(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110000.00", "90.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentLow(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110.00", "90000.00", "105.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentClose(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105000.00", "1000", "105.00")
    ...
    def testNotEqualTickerWithDifferentVolume(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "10000000", "105.00")
    ...
    def testNotEqualTickerWithDifferentAdjustedClose(self):
        ...
        tickerOne = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105.00")
        tickerTwo = Ticker("Google", "01-10-1986", "100.00", "110.00", "90.00", "105.00", "1000", "105000.00")
    ...
    def testGetDate(self):
        ...
        self.assertEqual(tickerOne.getDate(), "01-10-1986", "ticker one Date is not 01-10-1986")
